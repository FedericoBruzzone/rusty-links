...
mod test_snippets_simple_call_closure {
    ...
    #[test]
    fn test_call_closure_directly() -> Result<(), String> {
        let snippet =
    ...
    #[test]
    fn test_call_closure_alias() -> Result<(), String> {
    ...
    #[test]
    fn test_call_closure_ref_alias() -> Result<(), String> {
        let snippet =
    ...
    #[test]
    fn test_call_closure_directly_from_closure() -> Result<(), String> {
        let snippet =
    ...
    #[test]
    fn test_call_closure_alias_from_closure() -> Result<(), String> {
        let snippet =
    ...
    #[test]
    fn test_call_closure_ref_alias_from_closure() -> Result<(), String> {
        let snippet =
