...
mod test_snippets_simple_call_switch {
    ...
    #[test]
    fn test_simple_call_with_file_call_switch_directly_from_closure() -> Result<(), String> {
        let snippet =
    ...
    #[test]
    fn test_simple_call_with_file_call_switch_alias_from_closure() -> Result<(), String> {
        let snippet =
    ...
    #[test]
    fn test_simple_call_with_file_call_switch_ref_alias_from_closure() -> Result<(), String> {
        let snippet =
